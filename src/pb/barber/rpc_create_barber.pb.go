...
// 	protoc        v4.25.0
// source: barber/rpc_create_barber.proto
...
func (x *CreateBarberRequest) Reset() {
	*x = CreateBarberRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_barber_rpc_create_barber_proto_msgTypes[0]
...
func (*CreateBarberRequest) Descriptor() ([]byte, []int) {
	return file_barber_rpc_create_barber_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateBarberResponse) Reset() {
	*x = CreateBarberResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_barber_rpc_create_barber_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateBarberResponse) Descriptor() ([]byte, []int) {
	return file_barber_rpc_create_barber_proto_rawDescGZIP(), []int{1}
}
...
var File_barber_rpc_create_barber_proto protoreflect.FileDescriptor

var file_barber_rpc_create_barber_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x63, 0x72, 0x65,
	...
	0x62, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xec, 0x01, 0x0a, 0x13, 0x43, 0x72,
	...
	0x28, 0x05, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x3a, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x42, 0x61, 0x72, 0x62, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x22, 0x0a, 0x06, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
...
var (
	file_barber_rpc_create_barber_proto_rawDescOnce sync.Once
	file_barber_rpc_create_barber_proto_rawDescData = file_barber_rpc_create_barber_proto_rawDesc
)

func file_barber_rpc_create_barber_proto_rawDescGZIP() []byte {
	file_barber_rpc_create_barber_proto_rawDescOnce.Do(func() {
		file_barber_rpc_create_barber_proto_rawDescData = protoimpl.X.CompressGZIP(file_barber_rpc_create_barber_proto_rawDescData)
	})
	return file_barber_rpc_create_barber_proto_rawDescData
}

var file_barber_rpc_create_barber_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_barber_rpc_create_barber_proto_goTypes = []interface{}{
	(*CreateBarberRequest)(nil),  // 0: pb.CreateBarberRequest
	(*CreateBarberResponse)(nil), // 1: pb.CreateBarberResponse
	(*Barber)(nil),               // 2: pb.Barber
}
var file_barber_rpc_create_barber_proto_depIdxs = []int32{
...
func init() { file_barber_rpc_create_barber_proto_init() }
func file_barber_rpc_create_barber_proto_init() {
	if File_barber_rpc_create_barber_proto != nil {
		return
	}
	file_barber_barber_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_barber_rpc_create_barber_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_barber_rpc_create_barber_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_barber_rpc_create_barber_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_barber_rpc_create_barber_proto_goTypes,
		DependencyIndexes: file_barber_rpc_create_barber_proto_depIdxs,
		MessageInfos:      file_barber_rpc_create_barber_proto_msgTypes,
	}.Build()
	File_barber_rpc_create_barber_proto = out.File
	file_barber_rpc_create_barber_proto_rawDesc = nil
	file_barber_rpc_create_barber_proto_goTypes = nil
	file_barber_rpc_create_barber_proto_depIdxs = nil
}
