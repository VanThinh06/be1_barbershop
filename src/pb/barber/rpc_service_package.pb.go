...
type CreateServicePackageRequest struct {
	...
	ImageUrl     []byte   `protobuf:"bytes,7,opt,name=image_url,json=imageUrl,proto3,oneof" json:"image_url,omitempty"`
...
func (x *CreateServicePackageRequest) GetImageUrl() []byte {
	if x != nil {
		return x.ImageUrl
	}
	return nil
...
func (x *UpdateServicePackageRequest) GetImageUrl() []byte {
	if x != nil {
		return x.ImageUrl
	}
	return nil
...
var file_barber_rpc_service_package_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x48, 0x01, 0x52, 0x08, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x55, 0x72, 0x6c, 0x88, 0x01,
	...
	0x20, 0x01, 0x28, 0x0c, 0x48, 0x05, 0x52, 0x08, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x55, 0x72, 0x6c,
