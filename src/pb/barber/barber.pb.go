...
type AuthenticationBarber struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	BarberRoleId          int32                  `protobuf:"varint,8,opt,name=barber_role_id,json=barberRoleId,proto3" json:"barber_role_id,omitempty"`
	...
	AccessTokenExpiresAt  *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=access_token_expires_at,json=accessTokenExpiresAt,proto3" json:"access_token_expires_at,omitempty"`
	RefreshToken          string                 `protobuf:"bytes,12,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"`
	RefreshTokenExpiresAt *timestamppb.Timestamp `protobuf:"bytes,13,opt,name=refresh_token_expires_at,json=refreshTokenExpiresAt,proto3" json:"refresh_token_expires_at,omitempty"`
}

func (x *AuthenticationBarber) Reset() {
	*x = AuthenticationBarber{}
	if protoimpl.UnsafeEnabled {
		mi := &file_barber_barber_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AuthenticationBarber) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthenticationBarber) ProtoMessage() {}

func (x *AuthenticationBarber) ProtoReflect() protoreflect.Message {
	mi := &file_barber_barber_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthenticationBarber.ProtoReflect.Descriptor instead.
func (*AuthenticationBarber) Descriptor() ([]byte, []int) {
	return file_barber_barber_proto_rawDescGZIP(), []int{1}
}

func (x *AuthenticationBarber) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *AuthenticationBarber) GetGenderId() int32 {
	if x != nil {
		return x.GenderId
	}
	return 0
...
func (x *AuthenticationBarber) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *AuthenticationBarber) GetPhone() string {
	if x != nil {
		return x.Phone
	}
	return ""
...
func (x *AuthenticationBarber) GetNickName() string {
	if x != nil {
		return x.NickName
	}
	return ""
...
func (x *AuthenticationBarber) GetFullName() string {
	if x != nil {
		return x.FullName
	}
	return ""
...
func (x *AuthenticationBarber) GetAvatarUrl() string {
	if x != nil {
		return x.AvatarUrl
	}
	return ""
...
func (x *AuthenticationBarber) GetBarberRoleId() int32 {
	if x != nil {
...
func (x *AuthenticationBarber) GetBarberShopId() string {
	if x != nil {
...
func (x *AuthenticationBarber) GetAccessToken() string {
	if x != nil {
...
func (x *AuthenticationBarber) GetAccessTokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *AuthenticationBarber) GetRefreshToken() string {
	if x != nil {
...
func (x *AuthenticationBarber) GetRefreshTokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *BarberEmployee) Reset() {
	*x = BarberEmployee{}
	if protoimpl.UnsafeEnabled {
		mi := &file_barber_barber_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BarberEmployee) Descriptor() ([]byte, []int) {
	return file_barber_barber_proto_rawDescGZIP(), []int{2}
}
...
func (x *BarberDetail) Reset() {
	*x = BarberDetail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_barber_barber_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BarberDetail) Descriptor() ([]byte, []int) {
	return file_barber_barber_proto_rawDescGZIP(), []int{3}
}
...
func (x *BarberUpdate) Reset() {
	*x = BarberUpdate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_barber_barber_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BarberUpdate) Descriptor() ([]byte, []int) {
	return file_barber_barber_proto_rawDescGZIP(), []int{4}
}
...
var file_barber_barber_proto_rawDesc = []byte{
	...
	0x72, 0x2f, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x2e, 0x70,
	...
	0x28, 0x08, 0x52, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x84,
	0x04, 0x0a, 0x14, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x42, 0x61, 0x72, 0x62, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x67, 0x65, 0x6e, 0x64, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x67, 0x65, 0x6e, 0x64,
	...
	0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x24, 0x0a, 0x0e, 0x62, 0x61, 0x72,
	0x62, 0x65, 0x72, 0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x0c, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65, 0x49, 0x64, 0x12,
	0x24, 0x0a, 0x0e, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x5f, 0x73, 0x68, 0x6f, 0x70, 0x5f, 0x69,
	0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x53,
	0x68, 0x6f, 0x70, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f,
	...
	0x6e, 0x5f, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x5f, 0x61, 0x74, 0x18, 0x0d, 0x20, 0x01,
	...
	0x72, 0x65, 0x73, 0x41, 0x74, 0x22, 0x60, 0x0a, 0x0e, 0x42, 0x61, 0x72, 0x62, 0x65, 0x72, 0x45,
...
var file_barber_barber_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_barber_barber_proto_goTypes = []interface{}{
	(*Barbers)(nil),               // 0: pb.Barbers
	(*AuthenticationBarber)(nil),  // 1: pb.AuthenticationBarber
	(*BarberEmployee)(nil),        // 2: pb.BarberEmployee
	(*BarberDetail)(nil),          // 3: pb.BarberDetail
	(*BarberUpdate)(nil),          // 4: pb.BarberUpdate
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
	(*BarberRoles)(nil),           // 6: pb.BarberRoles
}
var file_barber_barber_proto_depIdxs = []int32{
	5, // 0: pb.AuthenticationBarber.access_token_expires_at:type_name -> google.protobuf.Timestamp
	5, // 1: pb.AuthenticationBarber.refresh_token_expires_at:type_name -> google.protobuf.Timestamp
	0, // 2: pb.BarberDetail.barber:type_name -> pb.Barbers
	6, // 3: pb.BarberDetail.barber_role:type_name -> pb.BarberRoles
...
func file_barber_barber_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_barber_barber_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthenticationBarber); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_barber_barber_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_barber_barber_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_barber_barber_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_barber_barber_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
