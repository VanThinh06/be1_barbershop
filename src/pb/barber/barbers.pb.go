...
type BarberEmployeeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BarberEmployeeRequest) Reset() {
	*x = BarberEmployeeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BarberEmployeeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BarberEmployeeRequest) ProtoMessage() {}

func (x *BarberEmployeeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_barber_barbers_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BarberEmployeeRequest.ProtoReflect.Descriptor instead.
func (*BarberEmployeeRequest) Descriptor() ([]byte, []int) {
	return file_barber_barbers_proto_rawDescGZIP(), []int{2}
}

func (x *BarberEmployeeRequest) GetPhone() string {
	if x != nil {
		return x.Phone
	}
	return ""
...
func (x *BarberEmployeeRequest) GetNickName() string {
	if x != nil {
		return x.NickName
	}
	return ""
...
func (x *BarberEmployeeRequest) GetFullName() string {
	if x != nil {
		return x.FullName
	}
	return ""
...
var file_barber_barbers_proto_rawDesc = []byte{
	...
	,
...
var file_barber_barbers_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_barber_barbers_proto_depIdxs = []int32{
	...
	3, // 1: pb.BarberEmployees.barber_role:type_name -> pb.BarberRoles
...
func file_barber_barbers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_barber_barbers_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BarberEmployeeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
