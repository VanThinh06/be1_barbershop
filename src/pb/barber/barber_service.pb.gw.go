...
func RegisterBarberServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BarberServiceServer) error {
	...
	mux.Handle("DELETE", pattern_BarberService_DeleteBarberEmployee_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.BarberService/DeleteBarberEmployee", runtime.WithHTTPPathPattern("/v1/barber/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBarberServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BarberServiceClient) error {
	...
	mux.Handle("DELETE", pattern_BarberService_DeleteBarberEmployee_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.BarberService/DeleteBarberEmployee", runtime.WithHTTPPathPattern("/v1/barber/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_BarberService_DeleteBarberEmployee_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "barber", "id"}, ""))
