...
type UpdateBarberRequest struct {
	...
	Barber       *BarberUpdate `protobuf:"bytes,1,opt,name=barber,proto3" json:"barber,omitempty"`
...
func (x *UpdateBarberRequest) GetBarber() *BarberUpdate {
	if x != nil {
		return x.Barber
	}
	return nil
...
func (x *UpdateBarberResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_barber_rpc_barbers_update_proto_rawDesc = []byte{
	...
	0x72, 0x62, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x65, 0x0a, 0x13, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x42, 0x61, 0x72, 0x62, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x28, 0x0a, 0x06, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x42, 0x61, 0x72, 0x62, 0x65, 0x72, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x52, 0x06, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x12, 0x24, 0x0a, 0x0e, 0x62,
	...
	0x64, 0x22, 0x30, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x61, 0x72, 0x62, 0x65,
...
var file_barber_rpc_barbers_update_proto_goTypes = []interface{}{
	...
	(*BarberUpdate)(nil),         // 2: pb.BarberUpdate
}
var file_barber_rpc_barbers_update_proto_depIdxs = []int32{
	2, // 0: pb.UpdateBarberRequest.barber:type_name -> pb.BarberUpdate
