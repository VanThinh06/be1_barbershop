...
type UpdateBarbersRequest struct {
	...
	GenderId     *string `protobuf:"bytes,3,opt,name=gender_id,json=genderId,proto3,oneof" json:"gender_id,omitempty"`
...
func (x *UpdateBarbersRequest) GetGenderId() string {
...
var file_barber_rpc_barbers_update_proto_rawDesc = []byte{
	...
	0x09, 0x48, 0x01, 0x52, 0x08, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x49, 0x64, 0x88, 0x01, 0x01,
