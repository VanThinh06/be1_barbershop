...
func (x *GetServicesRequest) GetChainId() string {
	if x != nil {
		return x.ChainId
	}
	return ""
...
var file_barber_rpc_get_services_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x48, 0x0a, 0x12, 0x47, 0x65, 0x74,
	...
	0x09, 0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x73, 0x68,
	0x6f, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x68, 0x6f,
	0x70, 0x49, 0x64, 0x22, 0x3e, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x08, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x70,
...
var file_barber_rpc_get_services_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_barber_rpc_get_services_proto_goTypes = []interface{}{
	(*GetServicesRequest)(nil),  // 0: pb.GetServicesRequest
	(*GetServicesResponse)(nil), // 1: pb.GetServicesResponse
	(*Service)(nil),             // 2: pb.Service
}
var file_barber_rpc_get_services_proto_depIdxs = []int32{
	2, // 0: pb.GetServicesResponse.services:type_name -> pb.Service
