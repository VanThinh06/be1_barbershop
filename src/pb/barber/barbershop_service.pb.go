...
type ItemBarberShopService struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ItemBarberShopService) Reset() {
	*x = ItemBarberShopService{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemBarberShopService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemBarberShopService) ProtoMessage() {}

func (x *ItemBarberShopService) ProtoReflect() protoreflect.Message {
	mi := &file_barber_barbershop_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemBarberShopService.ProtoReflect.Descriptor instead.
func (*ItemBarberShopService) Descriptor() ([]byte, []int) {
	return file_barber_barbershop_service_proto_rawDescGZIP(), []int{1}
}

func (x *ItemBarberShopService) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ItemBarberShopService) GetCategoryName() string {
	if x != nil {
		return x.CategoryName
	}
	return ""
...
func (x *ItemBarberShopService) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_barber_barbershop_service_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x22, 0x60, 0x0a, 0x15, 0x49, 0x74, 0x65, 0x6d, 0x42, 0x61, 0x72, 0x62, 0x65,
	0x72, 0x53, 0x68, 0x6f, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x1a, 0x5a, 0x18, 0x62, 0x61, 0x72, 0x62, 0x65, 0x72, 0x73,
...
var file_barber_barbershop_service_proto_goTypes = []interface{}{
	...
	(*ItemBarberShopService)(nil), // 1: pb.ItemBarberShopService
...
func file_barber_barbershop_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_barber_barbershop_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ItemBarberShopService); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
