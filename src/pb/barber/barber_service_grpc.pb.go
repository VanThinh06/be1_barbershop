...
const (
	...
	BarberService_UpdateBarberManagers_FullMethodName         = "/pb.BarberService/UpdateBarberManagers"
...
type BarberServiceClient interface {
	...
	UpdateBarberManagers(ctx context.Context, in *UpdateBarberManagersRequest, opts ...grpc.CallOption) (*UpdateBarberManagersResponse, error)
...
func (c *barberServiceClient) UpdateBarberManagers(ctx context.Context, in *UpdateBarberManagersRequest, opts ...grpc.CallOption) (*UpdateBarberManagersResponse, error) {
	out := new(UpdateBarberManagersResponse)
	err := c.cc.Invoke(ctx, BarberService_UpdateBarberManagers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *barberServiceClient) GetBarber(ctx context.Context, in *GetBarberRequest, opts ...grpc.CallOption) (*GetBarberResponse, error) {
	out := new(GetBarberResponse)
...
type BarberServiceServer interface {
	...
	UpdateBarberManagers(context.Context, *UpdateBarberManagersRequest) (*UpdateBarberManagersResponse, error)
...
func (UnimplementedBarberServiceServer) UpdateBarberManagers(context.Context, *UpdateBarberManagersRequest) (*UpdateBarberManagersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateBarberManagers not implemented")
}
...
func (UnimplementedBarberServiceServer) GetBarber(context.Context, *GetBarberRequest) (*GetBarberResponse, error) {
...
func _BarberService_UpdateBarberManagers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateBarberManagersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BarberServiceServer).UpdateBarberManagers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BarberService_UpdateBarberManagers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BarberServiceServer).UpdateBarberManagers(ctx, req.(*UpdateBarberManagersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BarberService_GetBarber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BarberServiceServer).GetBarber(ctx, req.(*GetBarberRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BarberService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateBarberManagers",
			Handler:    _BarberService_UpdateBarberManagers_Handler,
		},
		{
