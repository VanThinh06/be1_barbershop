...
func (server *Server) ListComboServices(ctx context.Context, req *barber.ListServicesByCategoryRequest) (*barber.ListServicesByCategoryResponse, error) {
	...
	rsp := &barber.ListServicesByCategoryResponse{
		BarberShopServices: convertListComboServices(res),
	}
	return rsp, nil
}
