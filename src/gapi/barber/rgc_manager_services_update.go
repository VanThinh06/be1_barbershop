...
func (server *Server) UpdateServicesPublicSeparate(ctx context.Context, req *barber.UpdateServicesPublicSeparateRequest) (*barber.CreateServicesResponse, error) {
	...
	arg := db.UpdateServicesPublicSeparateParams{
	...
	services, err := server.Store.UpdateServicesPublicSeparate(ctx, arg)
	if err != nil {
