...
RETURNING id, barber_shop_id, category_id, gender_id, name, timer, price, description, image_url, combo_services, is_active
`
...
SET 
    ...
    combo_services = CASE 
                        WHEN COALESCE($10, '{}')::text[] != '{}' THEN COALESCE($10, '{}')::text[]
                        ELSE combo_services
                    END
WHERE "id" = $1
`
