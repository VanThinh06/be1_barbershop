...
VALUES (
        $1,
        $2,
        ST_GeographyFromText('POINT(' || $3::float8 || ' ' || $4::float8 || ')'),
        $5,
        $6) RETURNING shop_id, owner_id, chain_id, name, facility, address, image, list_image, status, coordinates, rate, is_reputation, created_at, update_at
`
