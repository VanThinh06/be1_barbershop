...
SELECT "BarberRoles".id, "BarberRoles".barber_id, "BarberRoles".barbershop_id, "BarberRoles".role_id, "BarberRoles".create_at, "BarberRoles".update_at, "Roles"."name" as role_name
FROM "BarberRoles"
...
func (q *Queries) GetBarberRoles(ctx context.Context, arg GetBarberRolesParams) (GetBarberRolesRow, error) {
	row := q.db.QueryRowContext(ctx, getBarberRoles, arg.BarberID, arg.BarbershopID)
	var i GetBarberRolesRow
	err := row.Scan(
		&i.ID,
		&i.BarberID,
		&i.BarbershopID,
