...
WITH inserted_appointment AS (
    ...
    VALUES ($1, $2, $3, $4, $5)
    RETURNING id, barber_shop_id, customer_id, barber_id, appointment_date_time, status, create_at, update_at
)
SELECT 
    inserted_appointment.id, inserted_appointment.barber_shop_id, inserted_appointment.customer_id, inserted_appointment.barber_id, inserted_appointment.appointment_date_time, inserted_appointment.status, inserted_appointment.create_at, inserted_appointment.update_at,
...
SELECT 
    "Appointments".id, "Appointments".barber_shop_id, "Appointments".customer_id, "Appointments".barber_id, "Appointments".appointment_date_time, "Appointments".status, "Appointments".create_at, "Appointments".update_at,
