...
func (q *Queries) CreateAppointments(ctx context.Context, arg CreateAppointmentsParams) (CreateAppointmentsRow, error) {
	row := q.db.QueryRow(ctx, createAppointments,
		arg.BarberShopID,
		arg.CustomerID,
		arg.BarberID,
...
func (q *Queries) CreateServicesForAppointments(ctx context.Context, arg CreateServicesForAppointmentsParams) ([]BarberShopServicesAppointment, error) {
	rows, err := q.db.Query(ctx, createServicesForAppointments, arg.AppointmentsServiceID, arg.ServicesID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListAppointmentsByDate(ctx context.Context, arg ListAppointmentsByDateParams) ([]ListAppointmentsByDateRow, error) {
	rows, err := q.db.Query(ctx, listAppointmentsByDate, arg.AppointmentDateTime, arg.BarberID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
