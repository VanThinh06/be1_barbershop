...
VALUES ($1,
        ...
        $7,
        $8,
        $9) RETURNING username, full_name, email, hashed_password, avatar, role, status, store_work, store_manager, password_changed_at, created_at, update_at
`
...
SELECT username, full_name, email, hashed_password, avatar, role, status, store_work, store_manager, password_changed_at, created_at, update_at
FROM barber
WHERE username = $1
LIMIT 1
`
